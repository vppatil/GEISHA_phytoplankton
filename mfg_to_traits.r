...
mfg.to.traits<-function(MFG)
{
  ...
  if(is.na(MFG.num)){
    trait.df=data.frame(flagella = NA, 
                        autotroph = NA, 
                        size = NA, 
                        colonial = NA, 
                        centric = NA, 
...
mfg.to.traits.df<-function(df) 
{
  ...
  {
    print(i)
    trait.df=rbind(trait.df,
                   mfg.to.traits(df$MFG[i]))
  }
